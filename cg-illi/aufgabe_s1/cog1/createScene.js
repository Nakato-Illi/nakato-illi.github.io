...
function(exports, scenegraph, animation) {
	...
	function init() {
		...
		var cubeNode1 = scenegraph.createNodeWithModel("alle", "teapot", {scale:10});
		
		var cubeNode2 = scenegraph.createNodeWithModel("drei", "sphere", {scale:200}, cubeNode1);

		var cubeNode3 = scenegraph.createNodeWithModel("zwei", "cube", {scale:200}, cubeNode2);
		
		var cubeNode4 = scenegraph.createNodeWithModel("einer", "diamond", {scale:410}, cubeNode3);
